...
typedef std::tuple<TestPattern, BlkSize, SearchArea> SadLoopTestParam;
...
/**
 * @brief Unit test for SAD HME functions include:
 ...
 *
 */
class SadHmeTest : public ::testing::WithParamInterface<SadLoopTestParam>,
                   public SADTestBase {
  public:
    SadHmeTest()
        : SADTestBase(std::get<0>(TEST_GET_PARAM(1)),
  ...
  protected:
    void check_hme_loop() {
        ...
        int16_t x_search_center3 = 0;
        int16_t y_search_center3 = 0;
        sad_loop_kernel_avx2_hme_l0_intrin(src_aligned_,
                                           src_stride_,
                                           ref1_aligned_,
                                           ref1_stride_,
                                           height_,
...
class ExtSadCalculationTest
  ...
  protected:
    ...
    void check_get_32x32_sad() {
        ...
        ext_sad_calculation_32x32_64x64(*sad16x16_32b,
                                        best_sad32x32[0],
                                        &best_sad64x64[0],
                                        best_mv32x32[0],
                                        &best_mv64x64[0],
...
class SadCalculationTest
  ...
  protected:
    ...
    void check_get_32x32_sad() {
        ...
        sad_calculation_32x32_64x64(*sad16x16_32b,
                                    best_sad32x32[1],
                                    &best_sad64x64[1],
                                    best_mv32x32[1],
                                    &best_mv64x64[1],
